...
{	
	...
	public void writeCardType( String s )
	{
		if( cardPanel != null )
		{ 
			if( s.toUpperCase().equals( CardType.CREATURE.getName().toUpperCase() ))
			...
			if( s.toUpperCase().equals( CardType.PERMANENT.getName().toUpperCase() ))
	...
	public void paintTemplate(int id)
	{
		if( cardPanel != null )
		{
			if( id == Element.INCOLOR.getId() )
			{
				cardPanel.getLblTemplate().setIcon(new ImageIcon(CardGraphic.INCOLOR.getTemplate()));
			}
			else if( id == Element.WATER.getId() )
			{
				cardPanel.getLblTemplate().setIcon(new ImageIcon(CardGraphic.WATER.getTemplate()));
			}
			else if( id == Element.FIRE.getId() )
			{
				cardPanel.getLblTemplate().setIcon(new ImageIcon(CardGraphic.FIRE.getTemplate()));
			}
			else if( id == Element.AIR.getId() )
			{
				cardPanel.getLblTemplate().setIcon(new ImageIcon(CardGraphic.AIR.getTemplate()));
			}
			else if( id == Element.EARTH.getId() )
			{
				cardPanel.getLblTemplate().setIcon(new ImageIcon(CardGraphic.EARTH.getTemplate()));
			}
			else if( id == Element.LIGHT.getId() )
			{
				cardPanel.getLblTemplate().setIcon(new ImageIcon(CardGraphic.LIGHT.getTemplate()));
			}
			else if( id == Element.DARKNESS.getId() )
			{
				cardPanel.getLblTemplate().setIcon(new ImageIcon(CardGraphic.DARKNESS.getTemplate()));
			}
			else if( id == Element.LIFE.getId() )
			{
				cardPanel.getLblTemplate().setIcon(new ImageIcon(CardGraphic.LIFE.getTemplate()));
			}
			else if( id == Element.DEATH.getId() )
			{
				cardPanel.getLblTemplate().setIcon(new ImageIcon(CardGraphic.DEATH.getTemplate()));
			}
			else if( id == Element.SPACE.getId() )
			{
				cardPanel.getLblTemplate().setIcon(new ImageIcon(CardGraphic.SPACE.getTemplate()));
			}
			else if( id == Element.TIME.getId() )
			{
				cardPanel.getLblTemplate().setIcon(new ImageIcon(CardGraphic.TIME.getTemplate()));
			}
			else if( id == Element.NOUS.getId() )
			{
				cardPanel.getLblTemplate().setIcon(new ImageIcon(CardGraphic.NOUS.getTemplate()));
			}
			else if( id == Element.VOID.getId() )
			{
				cardPanel.getLblTemplate().setIcon(new ImageIcon(CardGraphic.VOID.getTemplate()));
			}
