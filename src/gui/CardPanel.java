...
public class CardPanel extends JPanel 
{
	...
	public CardPanel() 
	{
		...
		gifAtk = new JLabel("");
		gifAtk.setIcon(new ImageIcon( "C:\\Users\\Mau\\workspace\\CardGame\\img\\atk.png" ));
		...
		gifDif = new JLabel("");
		gifDif.setIcon(new ImageIcon( "C:\\Users\\Mau\\workspace\\CardGame\\img\\dif.png" ));
		...
		gifRng = new JLabel("");
		gifRng.setIcon(new ImageIcon( "C:\\Users\\Mau\\workspace\\CardGame\\img\\rng.png" ));
		...
		lblMark1 = new JLabel("");
		lblMark1.setIcon(new ImageIcon( cg.INCOLOR.getMark10() ));
		...
		lblMark2.setIcon(new ImageIcon( cg.INCOLOR.getMark10() ));
		add(lblMark2);
		
		lblMark3 = new JLabel("");
		lblMark3.setVisible(false);
		lblMark3.setBounds(238, 39, 28, 28);
		lblMark3.setIcon(new ImageIcon( cg.INCOLOR.getMark10() ));
		add(lblMark3);
		...
		lblTemplate.setIcon(new ImageIcon( cg.INCOLOR.getTemplate() ));
	...
	public void saveImage()
	{
        ...
        try
        {
            ImageIO.write(image,"png", new File("C:\\Users\\Mau\\workspace\\CardGame\\save\\" + lblName.getText() + ".png"));
        }
        catch(Exception e)
        {
        	e.printStackTrace();
